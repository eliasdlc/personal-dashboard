        ...
        >
            ...
            <div className="p-4 sm:p-6 flex flex-col gap-3 sm:gap-4">
                <Input
                    ...
                    className="border-none shadow-none focus-visible:ring-0 p-2 sm:p-4 text-lg sm:text-xl font-medium placeholder:text-slate-600 dark:placeholder:text-slate-600 text-slate-200 bg-transparent"
                    autoFocus
                />
                ...
                <div className="flex flex-row items-center justify-between gap-3 sm:gap-4">
                    <div className="flex flex-row items-center gap-2 sm:gap-3 w-full sm:w-auto overflow-x-auto no-scrollbar mask-linear-fade pr-2">
                        ...
                        {/* Energy Toggle */}
                        <div className="flex items-center bg-slate-900/50 rounded-xl p-1 border border-slate-800/50 shrink-0">
                            <button
                                type="button"
                            ...
                            <div className="w-px h-3 sm:h-4 bg-slate-800 mx-1" />
                            <button
                                type="button"
                        ...
                        {/* Divider */}
                        <div className="h-4 sm:h-6 w-px bg-slate-800/50 shrink-0" />
                                ...
                                <button
                                    ...
                                    className={cn(
                                        ...
                                        context === ctx.id
                                            ...
                                            : "bg-transparent border-transparent text-slate-600 hover:bg-slate-900 hover:text-slate-400"
                                    )}
                                    title={ctx.label}
                                >
